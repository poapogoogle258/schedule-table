...
func MigrateSetUpAndInitData(db *gorm.DB) error {
	...
	initResponsible := []*dao.Responsible{
		{ScheduleId: initSchedule.Id, MemberId: initMembers[0].Id, Queue: 1, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[1].Id, Queue: 2, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[2].Id, Queue: 3, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[3].Id, Queue: 4, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[4].Id, Queue: 5, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[5].Id, Queue: 6, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[6].Id, Queue: 7, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[7].Id, Queue: 8, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[8].Id, Queue: 9, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[9].Id, Queue: 10, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[10].Id, Queue: 11, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[11].Id, Queue: 12, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[12].Id, Queue: 13, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[13].Id, Queue: 14, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[14].Id, Queue: 15, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[15].Id, Queue: 16, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[16].Id, Queue: 17, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[17].Id, Queue: 18, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[18].Id, Queue: 19, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[19].Id, Queue: 20, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[20].Id, Queue: 21, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[21].Id, Queue: 22, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[22].Id, Queue: 23, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[23].Id, Queue: 24, Limit: 0},
		{ScheduleId: initSchedule.Id, MemberId: initMembers[24].Id, Queue: 25, Limit: 0},
	}
